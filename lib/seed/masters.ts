...
export const sites = [
  ...
  { id: 'S12', client_id: 'SIE', name: 'Logistica Central Warehouse - Al Sulay', city: 'Riyadh', address: 'Al Sulay Industrial Area, Riyadh', lat: 24.6061, lng: 46.8125, contact_name: 'Warehouse Desk', contact_phone: '+966 11 265 7788' },
]

export const warehouses = [
  { id: 'WH-RUH-01', code: 'WH-RUH-01', name: 'Logistica Central Warehouse - Al Sulay', city: 'Riyadh', capacity_pallets: 1200, operated_by: 'Siemens (SAP) - handover pending' },
  { id: 'WH-JED-01', code: 'WH-JED-01', name: 'Jeddah Islamic Port Bonded Store', city: 'Jeddah', capacity_pallets: 400, operated_by: 'Logistica' },
  { id: 'WH-DMM-01', code: 'WH-DMM-01', name: 'Dammam Transit Hub', city: 'Dammam', capacity_pallets: 300, operated_by: 'Logistica' },
...
export const staff = [
  S('LG-D-101', 'Mohammed Al-Qahtani', 'driver', 'own', '+966 55 331 2201', 'Riyadh', 4.8, 'DL-4421093'),
  S('LG-D-102', 'Rafeeq Ahmed Kutty', 'driver', 'own', '+966 55 331 2202', 'Riyadh', 4.6, 'DL-4421094'),
  S('LG-D-103', 'Shibu Varghese', 'driver', 'own', '+966 55 331 2203', 'Riyadh', 4.9, 'DL-4421095'),
  S('LG-D-104', 'Abdul Rahman Siddiqui', 'driver', 'own', '+966 55 331 2204', 'Jeddah', 4.3, 'DL-4421096'),
  S('LG-D-105', 'Anil Kumar Nair', 'driver', 'own', '+966 55 331 2205', 'Riyadh', 4.7, 'DL-4421097'),
  S('LG-D-106', 'Sajid Iqbal Khan', 'driver', 'own', '+966 55 331 2206', 'Dammam', 4.1, 'DL-4421098'),
  S('LG-D-107', 'Yousef Al-Ghamdi', 'driver', 'own', '+966 55 331 2207', 'Jeddah', 4.5, 'DL-4421099'),
  S('LG-D-108', 'Ramesh Chandran', 'driver', 'own', '+966 55 331 2208', 'Riyadh', 4.4, 'DL-4421100'),
  S('LG-D-201', 'Imran Hafeez', 'driver', 'outsourced', '+966 56 774 1120', 'Riyadh', 3.9, 'DL-5580021'),
  S('LG-D-202', 'Bilal Mehmood', 'driver', 'outsourced', '+966 56 774 1121', 'Jeddah', 4.0, 'DL-5580022'),
  S('LG-L-301', 'Sunil Thomas', 'labour', 'own', '+966 57 220 1101', 'Riyadh', 4.6),
  S('LG-L-302', 'Jaseem Abdulla', 'labour', 'own', '+966 57 220 1102', 'Riyadh', 4.5),
  S('LG-L-303', 'Noufal Rahman', 'labour', 'own', '+966 57 220 1103', 'Riyadh', 4.7),
  S('LG-L-304', 'Prakash Menon', 'labour', 'own', '+966 57 220 1104', 'Jeddah', 4.2),
  S('LG-L-305', 'Hamza Sheikh', 'labour', 'own', '+966 57 220 1105', 'Riyadh', 4.4),
  S('LG-L-306', 'Vinod Pillai', 'labour', 'own', '+966 57 220 1106', 'Dammam', 4.3),
  S('LG-L-401', 'Zakir Hussain', 'labour', 'outsourced', '+966 58 991 2210', 'Riyadh', 3.8),
  S('LG-L-402', 'Naveed Akram', 'labour', 'outsourced', '+966 58 991 2211', 'Riyadh', 3.95),
  S('LG-L-403', 'Salim Basheer', 'labour', 'outsourced', '+966 58 991 2212', 'Jeddah', 4.05),
  S('LG-S-501', 'Abdulaziz Al-Shammari', 'supervisor', 'own', '+966 55 442 0011', 'Riyadh', 4.85),
  S('LG-S-502', 'Nithin Joseph', 'supervisor', 'own', '+966 55 442 0012', 'Jeddah', 4.55),
  S('LG-C-601', 'Khalid Al-Zahrani', 'clearance_agent', 'own', '+966 55 660 3301', 'Riyadh', 4.75),
  S('LG-C-602', 'Faris Al-Subaie', 'clearance_agent', 'own', '+966 55 660 3302', 'Jeddah', 4.65),
  S('LG-C-603', 'Mansoor Ali', 'clearance_agent', 'outsourced', '+966 56 118 4420', 'Dammam', 4.2),
  S('LG-I-701', 'Eng. Deepak Sharma', 'installer', 'own', '+966 55 909 1101', 'Riyadh', 4.9),
  S('LG-I-702', 'Eng. Waleed Al-Harbi', 'installer', 'own', '+966 55 909 1102', 'Riyadh', 4.7),
  S('LG-I-703', 'Eng. Arun Prasad', 'installer', 'own', '+966 55 909 1103', 'Jeddah', 4.6),
]
...
export const app_settings = [
  ...
  { key: 'company_name', value: 'Logistica Clearing & Forwarding Est.', description: 'Legal entity shown on documents' },
